...
--theme.wallpaper_cmd = {"awsetbg -f wallpaper/0.jpg"}
...
globalkeys = awful.util.table.join(
    ...
    -- User program
	awful.key({ modkey, "Control" }, "p", function () awful.util.spawn("dmenu_run") end),
	awful.key({ modkey,  }, "v", function () awful.util.spawn("gvim") end),
	awful.key({ modkey,  }, "q", function () awful.util.spawn("qq2012") end),
	awful.key({ modkey, "Control" }, "w", function () awful.util.spawn("wiznote") end)
)
